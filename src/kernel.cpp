...
static std::map<int, unsigned int> mapStakeModifierCheckpoints =
    boost::assign::map_list_of(0, 0x000000000);
...
{
    //mango will hash in the transaction hash and the index number in order to make sure each hash is unique
...
{
	// mango TODO: renable once stacking generates a checkpoint
    /*
