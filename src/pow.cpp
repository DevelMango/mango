...
{
    /* current difficulty formula, mango - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
    ...
    if (nActualTimespan < _nTargetTimespan / 4)
        nActualTimespan = _nTargetTimespan / 4;
    if (nActualTimespan > _nTargetTimespan * 4)
        nActualTimespan = _nTargetTimespan * 4;
