...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* mango features */
        {"mango", "masternode", &masternode, true, true, false},
        {"mango", "masternodelist", &masternodelist, true, true, false},
        {"mango", "mnbudget", &mnbudget, true, true, false},
        {"mango", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"mango", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mango", "mnsync", &mnsync, true, true, false},
        {"mango", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"mango", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use enmanetd, or the -server option to mango-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mango-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11556/\n";
}
