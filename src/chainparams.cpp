...
static Checkpoints::MapCheckpoints mapCheckpoints =
        boost::assign::map_list_of
                (0, uint256("0x0000013db8091c3a4614371dc18f3ff96d1d02f10fc2c120cc9a6120aa202b90"))
	        (5, uint256("0x00000c9ed99ce3a66cb88a52184468213b5445e152a9a7a291dcfde20478c72d"));
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 4 * 60; // mango: 4 minutes
        nTargetSpacing = 2 * 60;  // mango: 2 minute
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 10; // mango: 10 seconds
        nTargetSpacing = 10;  // mango: 10 seconds
        nLastPOWBlock = 2000;
        nMaturity = 2;
        ...
        // Testnet mango BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet mango BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet mango BIP44 coin type is '1' (All coin's testnet default)
