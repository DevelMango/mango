                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    labelemntIcon = new QLabel();
    //labelemntIcon->setObjectName("XmxIcon");
    //labelemntIcon->setStyleSheet("QLabel {font-family: Segoe UI, Tahoe, Georgia, sans-serif, font-weight: 900; font-size: 14px; color: #606060; }");
    labelemntIcon->setPixmap(QIcon(":/icons/label_xmx").pixmap(37, 11));
    frameBlocksLayout->addStretch();
    frameBlocksLayout->addWidget(labelemntIcon);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a mango address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mango:URIs)"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About mango Core"), this);
    aboutAction->setStatusTip(tr("Show information about mango Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for mango"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(networkStyle->getAppIcon(), tr("&Show / Hide"), this);
    toggleHideAction->setStatusTip(tr("Show or hide the main Window"));

    encryptWalletAction = new QAction(QIcon(":/icons/encryptwallet_menu"), tr("&Encrypt Wallet..."), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your mango addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify_menu"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified mango addresses"));
    ...
    openInfoAction = new QAction(QIcon(":/icons/info_menu"), tr("&Information"), this);
    openInfoAction->setStatusTip(tr("Show diagnostic information"));
    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug console"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging console"));
    openNetworkAction = new QAction(QIcon(":/icons/network-peers_menu"), tr("&Network Monitor"), this);
    openNetworkAction->setStatusTip(tr("Show network monitor"));
    openPeersAction = new QAction(QIcon(":/icons/network-peers_menu"), tr("&Peers list"), this);
    ...
    usedSendingAddressesAction = new QAction(QIcon(":/icons/address-book_menu"), tr("&Sending addresses..."), this);
    usedSendingAddressesAction->setStatusTip(tr("Show the list of used sending addresses and labels"));
    usedReceivingAddressesAction = new QAction(QIcon(":/icons/address-book_menu"), tr("&Receiving addresses..."), this);
    usedReceivingAddressesAction->setStatusTip(tr("Show the list of used receiving addresses and labels"));
	
	///AAAA
    openAction = new QAction(QIcon(":/icons/editpaste_menu"), tr("Open &URI..."), this);
    openAction->setStatusTip(tr("Open a mango:URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info_menu"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the mango Core help message to get a list with possible mango command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("mango Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to mango network", "", count));
}
...
{
    QString strTitle = tr("mango"); // default title
