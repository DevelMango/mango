...
/** Utility functions used by the mango Qt UI.
 */
namespace GUIUtil
{
...
// Render mango addresses in monospace font
...
// Parse "mango:" URI into recipient object, return true on successful parsing
