...
In order to support loading of multiple wallets in mango-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mango.cpp.
...
Changes to mango.cpp
-------------------

mango.cpp is the entry point into mango-qt, and as such, will require some minor modifications to provide hooks for
