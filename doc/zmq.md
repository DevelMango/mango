...
The mango Core daemon can be configured to act as a trusted "border
router", implementing the mango wire protocol and relay, making
...
The ZeroMQ feature in mango Core requires ZeroMQ API version 4.x or
...
These options can also be provided in mango.conf.
