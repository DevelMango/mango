...
mango now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare <proposal-name> <url> <payment_count> <block_start> <enmanet_address> <monthly_payment_xmx>
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ mngo, _12_ times over the course of a year totaling _24000_ mngo.
...
mnbudget submit <proposal-name> <url> <payment_count> <block_start> <enmanet_address> <monthly_payment_xmx> <collateral_hash>
...
When block `1000000` is reached you'll receive a payment for `1200` mngo.
 ...
 * vote-many          - Vote on a mango initiative
 * vote-alias         - Vote on a mango initiative
 * vote               - Vote on a mango initiative/budget
