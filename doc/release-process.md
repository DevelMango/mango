...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/mangocoin/mango-core/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign mango Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit mango=v${VERSION} ../mango-core/contrib/gitian-descriptors/gitian-osx.yml
...
Codesigner only: Sign the osx binary:
    ...
    transfer mango-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [mango-detached-sigs](https://github.com/mangocoin/mango-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the http://bit.mangos/ server*.
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/mangocoin, ... but this will usually sort out itself

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/mangocoin/mango-core/releases/new) with a link to the archived release notes.
