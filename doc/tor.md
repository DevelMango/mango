TOR SUPPORT IN mango
===================

It is possible to run mango as a Tor hidden service, and connect to such services.
...
Run mango behind a Tor proxy
---------------------------

The first step is running mango behind a Tor proxy. This will already make all
...
HiddenServicePort 989 127.0.0.1:17555
...
your mangod's P2P listen port (17555 by default).

```
-externalip=X   You can tell mango about its publicly reachable address using
                this option, and this can be a .onion address. Given the above
                configuration, you can find your onion address in
                /var/lib/tor/mango-service/hostname. Onion addresses are given
...
and open port 17555 on your firewall (or use -upnp).
